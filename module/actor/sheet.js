       ...
       // console.log("add to pool");
        ...
        switch(rolled){
            case "body":
                ...
                break;
            case "spirit":
                data.dicePool += data.spirit;
                statRolled =  '<div class="pool-detail">'+game.i18n.localize("tftloop.spirit")+' +'+data.spirit+'</div>';
                break;
            case "heart":
            ...
            case "chi":
                data.dicePool += data.spirit;
                data.dicePool += data.chi;
                statRolled =  '<div class="pool-detail">'+game.i18n.localize("tftloop.spirit")+' +'+data.spirit+'</div>';
                statRolled += '<div class="pool-detail">'+game.i18n.localize("tftloop.chi")+' +'+data.chi+'</div>';
                break;
            case "control":
                data.dicePool += data.spirit;
                data.dicePool += data.program;
                statRolled =  '<div class="pool-detail">'+game.i18n.localize("tftloop.spirit")+' +'+data.spirit+'</div>';
                statRolled += '<div class="pool-detail">'+game.i18n.localize("tftloop.control")+' +'+data.control+'</div>';
                break;
            case "knowledge":
                data.dicePool += data.spirit;
                data.dicePool += data.knowledge;
                statRolled =  '<div class="pool-detail">'+game.i18n.localize("tftloop.spirit")+' +'+data.spirit+'</div>';
                statRolled += '<div class="pool-detail">'+game.i18n.localize("tftloop.knowledge")+' +'+data.knowledge+'</div>';
                break;
            case "contact":
                data.dicePool += data.heart;
